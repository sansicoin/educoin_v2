...
uint256 hashGenesisBlock("0xf10f67755ca2f8fd33ec2a0f7ab118ea4e190e4df4b1859050ce40d59e91ef37");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc082ef08927b0686900dadd9e587559cd16a42ba5f4f10bf60b49580eca02617");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1460529696;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 8546686;

        if (fTestNet)
        {
            block.nTime    = 1460529696;
            block.nNonce   = 388608931;
        }

...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Mon Apr 11 14:56:40 2016
...
CXXFLAGS      = -pipe -stdlib=libc++ -mmacosx-version-min=10.7 -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2 -arch x86_64 -pthread -fdiagnostics-show-option -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector $(DEFINES)
...
all: Makefile Educoinv-Qt.app/Contents/PkgInfo Educoinv-Qt.app/Contents/Resources/empty.lproj Educoinv-Qt.app/Contents/Info.plist Educoinv-Qt.app/Contents/Resources/educoinv.icns $(TARGET)
...
Educoinv-Qt.app/Contents/Info.plist: 
	...
	@sed -e "s,@SHORT_VERSION@,0.8,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,educoinv.icns,g" -e "s,@EXECUTABLE@,Educoinv-Qt,g" -e "s,@TYPEINFO@,????,g" share/qt/Info.plist >Educoinv-Qt.app/Contents/Info.plist
Educoinv-Qt.app/Contents/Resources/educoinv.icns: src/qt/res/icons/educoinv.icns
	@$(CHK_DIR_EXISTS) Educoinv-Qt.app/Contents/Resources/ || $(MKDIR) Educoinv-Qt.app/Contents/Resources/ 
	@$(DEL_FILE) Educoinv-Qt.app/Contents/Resources/educoinv.icns
	@$(COPY_FILE) src/qt/res/icons/educoinv.icns Educoinv-Qt.app/Contents/Resources/educoinv.icns
dist: 

...
# Generated by qmake (2.01a) (Qt 4.8.7) on: Tue Apr 12 15:22:45 2016
# Project:  Educoin-qt.pro
# Template: app
# Command: /usr/local/bin/qmake USE_UPNP=- USE_QRCODE=1 -o Makefile Educoin-qt.pro
#############################################################################
...
Makefile: Educoin-qt.pro  /usr/local/Cellar/qt/4.8.7_2/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.7_2/mkspecs/common/unix.conf \
	...
	$(QMAKE) USE_UPNP=- USE_QRCODE=1 -o Makefile Educoin-qt.pro
